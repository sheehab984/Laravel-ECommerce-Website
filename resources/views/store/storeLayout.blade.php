...
<head>
    ...
    <!-- Slick -->
    <link type="text/css" rel="stylesheet" href="{{asset('css/slick.css')}}css/slick.css" />
            ...
            <div id="responsive-nav">
                ...
                <ul class="main-nav nav navbar-nav">
                    ...
                    @if(Route::is('user.search'))
                        @foreach($cat as $c)
                        <li class="{{$c->id == $a ? 'active' : ''}}"><a href="search?c={{$c->id}}" >{{$c->name}}</a></li>
                        @endforeach
                        <li class="{{$a == -1  ? 'active' : ''}}"><a href="search">Browse</a></li>
                    @else
                        @foreach($cat as $c)
                        <li ><a href="search?c={{$c->id}}" >{{$c->name}}</a></li>
                        @endforeach
